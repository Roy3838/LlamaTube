...
train_config.model_name = "/home/ubuntu/LlamaTube/meta-llama-samsum"
...
tokenizer = AutoTokenizer.from_pretrained("/home/ubuntu/LLAMA_W/1")
...
eval_prompt = f"""Classify the title into one of the following categories: Worst, Bad, Average, Good, Great, Excellent, Perfect. title: {title} label: """

model_input = tokenizer(eval_prompt, return_tensors="pt").to("cuda")

print(tokenizer.decode(model_input))
